...
const features = [
  {
    name: "ReactJS",
    description: "I'm using the lastest version of React v18",
  },
  {
    name: "Tailwind CSS",
    description: "I use this lib for my project",
  },
  { name: "NodeJS", description: "Using NodeJS to code backend" },
  { name: "MongoDB", description: "I use mongoDB for my database" },
  { name: "ExpressJS", description: "The framework of backkend" },
  {
    name: "Docker",
    description: "I use docker to deploy this app",
  },
];
...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      const respsonse = await UserService.getUsers();
    ...
    <div className=" py-24 px-4 grid items-center grid-cols-1 gap-y-16 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
      <div>
        ...
        <p className="mt-4 text-gray-500">
          This is a basic react app building by rice, the app have
          Authentication , Authorization, Simple CRUD using ReactJS, Tailwind
          CSS, NodeJS, MongoDB
        </p>
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
        ...
        />
        <img
          src="https://cdn.auth0.com/blog/nodejs-awesome-polls/nodejs_logo.png"
          alt="NodeJS"
          className="bg-gray-100 rounded-lg"
        />
        <img
          src="https://avatars.githubusercontent.com/u/45798453?s=280&v=4"
          alt="MongoDB"
          className="bg-gray-100 rounded-lg"
        />
      </div>
