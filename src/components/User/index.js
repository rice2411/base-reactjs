...
export default function User() {
  ...
  return (
    <div className="my-10">
      ...
      <div
        className={`overflow-x-auto relative  sm:rounded-lg ${
          mode ? "" : "shadow-md"
        }  `}
      >
        <div
          className={`flex justify-between items-center pb-4 ${
            mode ? "bg-white" : "dark:bg-gray-900"
          } `}
        >
          <div>
            <button
              ...
              className={`inline-flex items-center   font-medium rounded-lg text-sm px-3 py-1.5 ${
                mode
                  ? "text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100"
            ...
            >
              <ul
                className={`py-1 text-sm ${
                  mode ? "text-gray-700" : "dark:text-gray-200"
                }  `}
          ...
          <div className="relative">
            <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
              <svg
                className={`w-5 h-5 ${
                  mode ? "text-gray-500 " : "dark:text-gray-400"
                } `}
                aria-hidden="true"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <input
              ...
              className={`block p-2 pl-10 w-80 text-sm rounded-lg border ${
                mode
